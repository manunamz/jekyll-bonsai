...
export default class NoteController extends Stimulus.Controller {
  static targets = [ "title" ];

  connect() {
    console.log("Hello, Stimulus NoteController!", this.element);
  }
  ...
  visit(e) {
    ...
    document.getElementById("visited-nav").dispatchEvent(
      new Event('update-visited'),
      { title: this.titleTarget.innerText }
    ); // tell VisitedNavController to update visited tabs
    // document.getElementById("note").visitedNav.updateVisited(this.titleTarget);
    // console.log(this.element.visitedNav);
    // this.element.visitedNav.updateVisited(this.titleTarget);
  }
